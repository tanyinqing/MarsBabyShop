...
public class AddressDetailModel implements Parcelable {
	...
	public AddressDetailModel(int id, String name, String phonenumber, String fixedtel, int provinceid, int cityid,
	...
	public static final Creator<AddressDetailModel> CREATOR = new Creator<AddressDetailModel>() {
		...
		@Override
		public AddressDetailModel createFromParcel(Parcel source) {
			return new AddressDetailModel(source);
		}
